<template>
  <div class="content">
    <div class="content-form">
      <svg width="228" height="53" viewBox="0 0 1353 319" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <v-card class="mx-auto pa-12 pb-8" elevation="8" min-width="448" rounded="lg">
        ...
        <v-form @submit.prevent="handleSubmit">
          ...
          <v-btn type="submit" :loading="loadingBtn" block class="mb-8" color="blue" size="large" variant="tonal">登 录</v-btn>
        </v-form>
      </v-card>
    </div>
  </div>
...
<script>
import { useLoginSetup } from './hooks';
